/**
 * FIFA World Cup 26 Annex C — combinations for the eight best third-placed teams.
 * Source: FWC2026 regulations, Annex C (495 rows = C(12,8)).
 * @see https://digitalhub.fifa.com/m/636f5c9c6f29771f/original/FWC2026_regulations_EN.pdf
 */

/** Group winners who face a third-placed team in the Round of 32 (column order). */
export const ANNEX_C_WINNERS = ['A', 'B', 'D', 'E', 'G', 'I', 'K', 'L'] as const;

/** Eight third-place group letters per qualifying combination, in ANNEX_C_WINNERS column order. */
