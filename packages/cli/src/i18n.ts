...
const EN = {
  ...
  'err.source': 'Unknown data source {source}. Available: espn.',
...
const ES: Dict = {
  ...
  'err.source': 'Fuente de datos desconocida {source}. Disponible: espn.',
...
const PT: Dict = {
  ...
  'err.source': 'Fonte de dados desconhecida {source}. Disponível: espn.',
...
const FR: Dict = {
  ...
  'err.source': 'Source de données inconnue {source}. Disponible : espn.',
