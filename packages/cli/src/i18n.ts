...
const EN: Dict = {
  ...
  'bracket.stage': 'Knockout · {stage}',
  'bracket.degraded': 'Live scores unavailable — bracket structure only, no confirmed advancement.',
  'bracket.standingsDegraded': 'Live standings unavailable — group slots stay TBD until groups finish.',
